// COLOURS
export const typographyPrimary = 'text-slate-900 dark:text-white'
export const typographySecondary = 'text-slate-500 dark:text-slate-400'
export const typographyPrimaryInverted = 'text-white'
export const typographyAccent = 'text-indigo-600 dark:text-indigo-500'
export const hoverTypographyAccent = 'hover:text-indigo-600 dark:hover:text-indigo-500'

export const backgroundPrimary = 'bg-white dark:bg-slate-900'
export const backgroundPrimaryDark = 'dark:bg-slate-900'
export const backgroundPrimaryHover = 'hover:bg-slate-50 dark:hover:bg-slate-800'

export const UIAccent = 'bg-indigo-600 dark:bg-indigo-500'
export const hoverUIAccent = 'hover:bg-indigo-700 dark:hover:bg-indigo-600'
